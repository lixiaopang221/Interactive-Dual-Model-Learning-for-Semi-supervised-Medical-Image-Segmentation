...
class MobileNet_UNet(nn.Module):
    def __init__(self, in_chns, class_num):
        ...
        # ---------------------------------------------------#
        self.backbone = mobilenet(in_chns)
        ...
        self.oup1 = nn.Conv2d(64, class_num, kernel_size=1)
        self.oup2 = nn.Conv2d(64, class_num, kernel_size=1)
    ...
    def forward(self, x):
        ...
        # print(P5.shape)
        P4 = x1                       # P4: 26x26x512
        P4 = torch.cat([P4, P5], axis=1)   # P4(¶Ñµþºó): 26x26x1024
        # print(f"cat ºóÊÇ£º {P4.shape}")
