...
parser.add_argument('--exp', type=str,
                    default='BraTS2019/Dual Learning', help='experiment_name')
...
def train(args, snapshot_path):
    ...
    residual_logit_criterion = losses.softmax_kl_loss
    eucliden_distance = losses.softmax_kl_loss
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            # segmentation loss
            stu1_loss_ce = ce_loss(stu1_seg_logit[:args.labeled_bs], label_batch[:][:args.labeled_bs].long())
            ...
            stu2_loss_ce = ce_loss(stu2_seg_logit[:args.labeled_bs], label_batch[:][:args.labeled_bs].long()) 
            ...
            stu1_consistency_loss1 = consistency_weight * consistency_criterion(stu1e_seg_logit, stu1_seg_logit)
            ...
            stu2_consistency_loss1 = consistency_weight * consistency_criterion(stu2e_seg_logit, stu2_seg_logit)
            ...
            in_stu2_cons_logit = Variable(stu2e_seg_logit[args.labeled_bs:].detach().data, requires_grad=False)
            ...
            in_stu1_cons_logit = Variable(stu1e_seg_logit[args.labeled_bs:].detach().data, requires_grad=False)
            ...
            if iter_num % 20 == 0:
                ...
                outputs_soft = torch.softmax(stu1_seg_logit, dim=1)
            ...
            if iter_num > 0 and iter_num % 200 == 0:
                ...
                avg_metric = test_all_case(
                    stu1_model, args.root_path, test_list="val.txt", num_classes=2, patch_size=args.patch_size,
