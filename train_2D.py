...
parser.add_argument('--model', type=str,
                    default='unet_dual', help='model_name, if backbone is unet_dual or denseunet')
...
'''def toColor(img, fileName):
    ...
    pathName = '../pseudo_label/dual_student'
    label2color_dict = {
        0: [0,0,0],
        1: [102, 205, 170], 
        2: [100, 149, 237],
...
def train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            stu1_res_loss1 = args.logit_distance_cost * residual_logit_criterion(stu1_seg[:args.labeled_bs], stu1_cons_logit[:args.labeled_bs])
            stu1_res_loss2 = args.logit_distance_cost * residual_logit_criterion(stu1_seg[:args.labeled_bs], stu1e_cons_logit[:args.labeled_bs]) 
            stu2_res_loss1 = args.logit_distance_cost * residual_logit_criterion(stu2_seg[:args.labeled_bs], stu2_cons_logit[:args.labeled_bs]) 
            stu2_res_loss2 = args.logit_distance_cost * residual_logit_criterion(stu2_seg[:args.labeled_bs], stu2e_cons_logit[:args.labeled_bs])''' 
            ...
            stu1_loss = stu1_seg_loss #+ stu1_res_loss1 + stu1_res_loss2 
            stu2_loss = stu2_seg_loss #+ stu2_res_loss1 + stu2_res_loss2 
            ...
            #mask1_stu2 = stu2_mask * stu1_mask_inv
            ...
            mask1_stu1 = stu1_mask * stu2_mask_inv
            ...
            #logging.info('iteration %d : stu1_loss : %f' % (iter_num, stu1_loss.item()))
